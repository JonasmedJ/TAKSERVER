...
read -p "   Are you ready to run the script? (Y/n): " ready_choice
...
if [ ! -d "$subfolder" ]; then
    echo "Error: Failed to create the subfolder. Exiting."
    exit 1
fi
...
<preferences>
  ...
  <preference version="1" name="com.atakmap.app_preferences">
    ...
    <entry key="staleRemoteDisconnects" class="class java.lang.Boolean">true</entry>
  </preference>
</preferences>
EOL
